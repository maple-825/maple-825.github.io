function typewrite()
{
    let str="<一生至少该有一次，为了某个人而忘了自己，<不求有结果，不求同行，不求曾经拥有，甚至不求你爱我，<只求在我最美的年华里，<遇到你<";//利用<作为换行符 -作为空格
    let strp="";
    let i=0;
    function print1()
    {
...
let a=[
    {name:"A" ,yin:8, str:"<br><br><br><br>我想你一定很忙，<br><br>所以你只看前三个字就好。"},
    {name:"B" ,yin:7, str:`<br><br><br>若逢新雪初霁，满月当空<br>下面平铺着皓影，上面流转着亮银，<br><br>而你带笑地向我走来，<br><br>月色和雪色之间 ，是第三种绝色 ，<br><br>与我而言， 日月星辉之中，你是第四种难得。`},
    {name:"C" ,yin:3, str:"<br><br><br><br>我总是想些无关紧要的事<br><br>比如宇宙的目的，熬夜与猝死的关系<br><br>你是否曾喜欢我"},
    {name:"D" ,yin:5, str:"<br><br><br><br>你在我身边也好，在天边也罢，<br>想到世界的角落有一个你，<br><br>便觉得整个世界也变得温柔安定了。"},
    ...
    {name:"N" ,yin:3, str:"<br><br><br><br>遇见你已经花光我所有的运气，<br><br>我再也没有机会蒙对选择题。"},
    {name:"O" ,yin:5, str:"<br><br><br><br>我们或者在月光下闲游，<br><br>或者在灯光下谈心，<br><br>手握着手，心对着心。"},
    ...
    {name:"W" ,yin:3, str:"<br><br><br><br>这个世界疯狂,没人性,腐败。<br><br>您却一直清醒,温柔,<br><br>一尘不染。"},
...
function fl(e)
{
    ...
    if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
    {
        ...
        if(s.indexOf("XIABAOXIABAOWXHN")!=-1&&records==0)
        {
            setTimeout(function()
            {
                records=1;
