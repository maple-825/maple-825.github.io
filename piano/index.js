...
let a=[
    ...
    {name:"H" ,yin:2, str:"<br><br>你的双眸有遥远的冬雪，你的微笑有绚烂的夏阳，<br></br>你一转身便有花开为你，你一低头便有星辰黯然，<br></br>你在我心里，我便拥有全世界。"},
    ...
    {name:"O" ,yin:7, str:"<br><br><br><br>我们或者在月光下闲游，<br><br>或者在灯光下谈心，<br><br>手握着手，心对着心。"},
    ...
    {name:"V" ,yin:8, str:"<br><br><br><br>我一生都是坚定不移的唯物主义者<br><br>唯有你<br><br>我希望有来生。"},
    {name:"W" ,yin:23, str:"<br><br><br><br>这个世界疯狂,没人性,腐败。<br><br>您却一直清醒,温柔,<br><br>一尘不染。"},
    {name:"X" ,yin:3, str:"<br><br><br><br>纵然万劫不复，<br><br>纵然相思入骨，我也待你眉眼如初，<br><br>岁月如故。"},
...
function fl(e)
{
    ...
    if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
    {
        ...
        if(s.indexOf("HXLOVE")!=-1&&records==0)
        {
            setTimeout(function()
            {
                records=1;
