...
let a=[
    {name:"A",yin:3, str:"<br><br><br>我喜欢你，不分日夜，我喜欢你，无关其他，喜欢便是喜欢，多一点不行，少一点也不可以。<br><br>还有....,其他的键<br><br>那些都是关于你的声音。以及，找一下声音里关于你的线索。"},
    ...
    {name:"D" ,yin:5, str:"<br><br><br><br>清风微拂<br>春风微暖<br>山河入梦<br><br>你入我心"},
    {name:"E" ,yin:8, str:"<br><br><br><br>若是你决定了要来见我<br><br>请务必提前一周告诉我<br><br>我好将10200个小时前的相见再反复回想"},
    {name:"F" ,yin:3, str:"<br><br><br><br>我喜欢你<br><br>剩余一行<br><br>笔给你"},
    ...
    {name:"N" ,yin:14, str:"<br><br><br><br>月亮照回湖心<br><br>野鹤奔向闲云<br><br>我步入你"},
    ...
    {name:"Q" ,yin:2, str:"<br><br><br><br>你一眨眼，清澈的溪水有跳动一下，<br><br>柔软的暖风有轻拂一下，遥远的星星有闪烁一下，<br><br>我也有心动，却不止一下。"},
    {name:"R" ,yin:7, str:"<br><br><br><br>星河璀璨，阳光干净，<br><br>在人间所有美好的存在里，<br><br>不论是活着或者死去，我总是最爱你。"},
    {name:"S" ,yin:2, str:"<br><br>我的心是亿万光年恒星爆炸后的残骸，荒烟蔓草，满目疮痍。<br><br>你来到这里，携着万千欢喜，覆在贫瘠之地上。枯木逄春，<br></>从此我的世界里只有为你而绽的名为爱的绝色。"},
    {name:"T" ,yin:8, str:"<br><br>写信真是一件温柔的事，细腻的小心思就藏在横竖撇捺之中，<br><br>像是一只害羞的小兽躲在情意绵绵的字里行间，被火漆封印起来，<br><br>等着解封的那一刻窜出来，跳进启信人眼底的柔波里。"},
    {name:"U" ,yin:21, str:"<br><br>我把我整个的灵魂都给你，<br><br>连同它的怪癖，耍小脾气，忽明忽暗，<br><br>一千八百种坏毛病， 它真讨厌。只有一点好， 爱你"},
    ...
    {name:"Y" ,yin:5, str:"<br><br><br><br>月遇从云，花遇和风，<br><br>今晚上的夜空很美，<br><br>我又想你。"},
...
function fl(e)
{
    ...
    if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
    {
        ...
        if(s.indexOf("HANXIAHANXIAWXHN")!=-1&&records==0)
        {
            setTimeout(function()
            {
                records=1;
