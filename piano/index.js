...
let a=[
    {name:"A",yin:1, str:"<br><br><br>我喜欢你，不分日夜，我喜欢你，无关其他，喜欢便是喜欢，多一点不行，少一点也不可以。<br><br>还有....,其他的键<br><br>那些都是关于你的声音。以及，找一下声音里关于你的线索。"},
    ...
    {name:"D" ,yin:4, str:"<br><br><br><br>清风微拂<br>春风微暖<br>山河入梦<br><br>你入我心"},
    ...
    {name:"W" ,yin:23, str:"<br><br><br><br>这个世纪疯狂,没人性,腐败。<br><br>您却一直清醒,温柔,<br><br>一尘不染。"},
...
function fl(e)
{
    ...
    if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
    {
        ...
        if(s.indexOf("HXWXHN")!=-1&&records==0)
        {
            setTimeout(function()
            {
                records=1;
